...
export default function TestimonialSliderTwo() {
	...
	return (
		<div className="section bg-warning-200 monke-section-padding2">
			<div className="container">
				<div className="monke-section-title">
					<h2>1600+ traders admit that monke is the best crypto</h2>
				</div>
				<div className="monke-testimonial-slider2">
					<Slider {...settings}>
						<div className="monke-testimonial-card2">
							<ul>
								<li>
				...
				<div className="monke-testimonial-btn">
					<Link href={"contact"} legacyBehavior>
						<a className="monke-btn monke-header-btn monke-header-btn2">Read 18k other reviews</a>
					</Link>
				</div>
			</div>
		</div>
