...
export default function PricingSectionOne() {
	...
	return (
		<div className="section bg-warning-300 monke-section-padding2">
			<div className="container">
				...
				<div className="row" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
					<div className="col-lg-4 col-md-6">
						<div className="monke-pricing-wrap wow fadeInUpX" data-wow-delay=".10s">
							...
							<div className="monke-pricing-price">
								...
								<div className="monke-price">{toggleBilled ? "99" : "19"}</div>
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-pricing-wrap wow fadeInUpX active" data-wow-delay=".10s">
							<div className="monke-pricing-header">
								<h5>Standard</h5>
								<p>Suitable for small companies and personal use</p>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "199" : "89"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<Link href={"#"}>Choose the plan</Link>
							<div className="monke-pricing-body">
							...
							<div className="monke-pricing-label">Popular</div>
						</div>
					</div>
					<div className="col-lg-4 col-md-6">
						<div className="monke-pricing-wrap wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke-pricing-header">
								<h5>Premium</h5>
								<p>Suitable for small companies and personal use</p>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "299" : "199"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<Link href={"#"}>Choose the plan</Link>
							<div className="monke-pricing-body">
