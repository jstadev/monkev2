...
export default function PricingSectionTwo() {
	...
	return (
		<div className="section monke-section-padding3">
			<div className="container">
				...
				<div className="row" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
					<div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
						<div className="monke-pricing-wrap monke-pricing-wrap3 wow fadeInUpX" data-wow-delay="0s">
							<div className="monke-pricing-header">
								<h5>Basic</h5>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "99" : "29"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<p>Suitable for small companies and personal use</p>
							<div className="monke-pricing-body">
							...
							<Link href={"#"} legacyBehavior>
								<a className="monke-pricing-btn">Choose the plan</a>
							</Link>
						</div>
					</div>
					<div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
						<div className="monke-pricing-wrap monke-pricing-wrap3 wow fadeInUpX" data-wow-delay=".10s">
							<div className="monke-pricing-header">
								<h5>Starter Plan</h5>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "199" : "19"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<p>Suitable for small companies and personal use</p>
							<div className="monke-pricing-body">
					...
					<div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
						<div className="monke-pricing-wrap monke-pricing-wrap3 wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke-pricing-header">
								<h5>Professional Plan</h5>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "249" : "49"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<p>Suitable for small companies and personal use</p>
							<div className="monke-pricing-body">
					...
					<div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
						<div className="monke-pricing-wrap monke-pricing-wrap3 wow fadeInUpX" data-wow-delay=".30s">
							<div className="monke-pricing-header">
								<h5>Exclusive Plan</h5>
							</div>
							<div className="monke-pricing-price">
								<span className="monke-pricing-currency">$</span>
								<div className="monke-price">{toggleBilled ? "199" : "99"}</div>
								<p className="bottom_text">{toggleBilled ? "/m" : "/y"}</p>
							</div>
							<p>Suitable for small companies and personal use</p>
							<div className="monke-pricing-body">
