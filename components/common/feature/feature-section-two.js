...
export default function FeatureSectionTwo() {
	return (
		<div className="section bg-warning-400 monke-section-padding3">
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-lg-6">
						<div className="monke-iconbox-wrap wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="monke-iconbox-wrap wow fadeInUpX" data-wow-delay=".30s">
							<div className="monke-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="monke-iconbox-wrap wow fadeInUpX" data-wow-delay=".40s">
							<div className="monke-iconbox-icon">
