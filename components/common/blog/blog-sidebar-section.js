...
export default function BlogSidebarSection() {
	return (
		<div className="monke--blog-sidebar">
			<div className="monke--blog-sidebar-item">
				<div className="monke--newsletter monke--search">
			...
			<div className="monke--blog-sidebar-item">
				...
				<div className="monke--blog-post-wrap">
					<div className="monke--blog-post-thumb">
						<Link href={"#"}>
							<img src="/images/all-img/blog2/dark/blog1.png" alt="" />
						</Link>
					</div>
					<div className="monke--blog-post-data">
						<Link href={"#"}>
							<p>July 27, 2022</p>
						</Link>
						<Link href={"#"}>
