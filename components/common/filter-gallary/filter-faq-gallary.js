...
export default function FilterFaqGallary() {
	return (
		<div className="section monke-section-padding2">
			<div className="container">
				<div className="monke-section-title">
					<h2>Ask any questions related to our services or products</h2>
				</div>

				<Tabs defaultActiveKey="general" className="monke-tab-menu">
					<Tab eventKey="general" title="General Question">
						<div className="row">
							<div className="col-md-6">
								<Accordion defaultActiveKey="0" className="nexto-accordion-one">
					...
					<Tab eventKey="account" title="Account & Support">
						<div className="row">
							<div className="col-md-6">
								<Accordion defaultActiveKey="0" className="nexto-accordion-one">
									<Accordion.Item eventKey="0">
					...
					<Tab eventKey="returns" title="Returns Policy">
						<div className="row">
							<div className="col-md-6">
								<Accordion defaultActiveKey="0" className="nexto-accordion-one">
									<Accordion.Item eventKey="0">
					...
					<Tab eventKey="technical" title="Technical Methods">
						<div className="row">
							<div className="col-md-6">
								<Accordion defaultActiveKey="0" className="nexto-accordion-one">
									<Accordion.Item eventKey="0">
