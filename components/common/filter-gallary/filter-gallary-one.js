...
export default function FilterGalarryOne() {
	...
	useEffect(() => {
		setTimeout(() => {
			isotope.current = new Isotope("#monke--four-column", {
	...
	return (
		<div className="monke--portfolio-section monke--section-padding">
			<div className="container">
				...
				<div className="monke--portfolio-wrap" id="monke--four-column">
