...
export default function FilterGallaryThree() {
	...
	useEffect(() => {
		setTimeout(() => {
			isotope.current = new Isotope("#monke-gallery-masonay2", {
				itemSelector: ".monke-grid-item",
				masonry: {
					columnWidth: ".monke-grid-item",
					gutterWidth: 0,
				},
				resizable: false,
			});
	...
	return (
		<div className="section monke-section-padding">
			<div className="container">
				...
				<div className="monke-gallery-wrap row" id="monke-gallery-masonay2">
					<div
						className="monke-grid-item col-lg-6 col-sm-12 branding commercial wow fadeInUpX"
						data-wow-delay="0s"
					>
						<div className="monke-gallery-item item2">
							<img src="/images/all-img/portfolio/p1.png" alt="" />
							<div className="monke-gallery-data2">
								<h4>
									<Link href={"/single-portfolio"}> Artwork wall printing </Link>
								</h4>
								<p>Digital Art</p>
								<Link href="single-portfolio" legacyBehavior>
									<a className="monke-icon-btn">
					...
					<div className="monke-grid-item col-lg-6 col-sm-12 commercial wow fadeInUpX" data-wow-delay=".10s">
						<div className="monke-gallery-item item2">
					...
					<div className="monke-grid-item col-lg-6 col-sm-12 design wow fadeInUpX" data-wow-delay=".20s">
						<div className="monke-gallery-item item2">
					...
					<div
						className="monke-grid-item col-lg-6 col-sm-12 digital design wow fadeInUpX"
						data-wow-delay=".30s"
					>
						<div className="monke-gallery-item item2">
					...
					<div className="monke-grid-item col-lg-6 col-sm-12 commercial wow fadeInUpX" data-wow-delay=".50s">
						<div className="monke-gallery-item item2">
				...
				<div className="monke-portfolio-btn">
					<Link href={"#"} legacyBehavior>
						<a className="monke-btn small-btn">View All</a>
					</Link>
				</div>
			</div>
		</div>
