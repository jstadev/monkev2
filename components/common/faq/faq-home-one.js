					...
					<div className="col-lg-5 position-relative">
						<div className="monke-default-content large-content">
							...
							<Link href={"/contact"} legacyBehavior>
								<a className="monke-faq-btn">Don't find the answer? Contact us here</a>
							</Link>
						</div>
					</div>

					<div className="col-lg-5 offset-lg-2">
						<div className="monke-accordion-wrap">
							<div className="monke-accordion-item">
								<h4>Is it safe to use crypto app?</h4>
								<p>
									Yes, monke crypto app and Coinbase are safe and use security measures that are
									industry-standard or above for U.S.-based.
								</p>
							</div>
							<div className="monke-accordion-item">
								<h4>How do I connect monke to my crypto wallet?</h4>
								<p>
									Once you ve approved a connection request from the app the monke can send transaction
