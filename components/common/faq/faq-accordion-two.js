...
export default function FaqAccordionTwo() {
	return (
		<div className="monke--faq-section2 monke--section-padding-bottom">
			<div className="container">
				...
				<div className="monke--accordion-one accordion-three" id="accordionExample2">
					<div className="row">
			...
			<div className="monke--circle-shape circle-five">
				<img src="/images/all-img/shapes-round.png" alt="" />
				<div className="waves wave-1"></div>
			</div>
			<div className="monke--circle-shape circle-six">
				<img src="/images/all-img/shapes-round.png" alt="" />
				<div className="waves wave-1"></div>
			</div>
			<div className="monke--circle-shape circle-seven">
				<img src="/images/all-img/shapes-round.png" alt="" />
				<div className="waves wave-1"></div>
			</div>
		</div>
