...
export default function CommentListSection() {
	return (
		<div className="monke-comment-section">
			<h5>3 comments on this post:</h5>
			<div className="monke-comment-wrap">
				<div className="monke-comment-item">
					<div className="monke-comment-author">
						<img src="/images/all-img/blog/comment1.png" alt="" />
					</div>
					<div className="monke-comment-author-data">
				...
				<div className="monke-comment-item">
					<div className="monke-comment-author author2">
