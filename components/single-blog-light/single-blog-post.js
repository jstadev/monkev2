...
export default function SingleBlogPost() {
	return (
		<div className="monke-blog-single-wrap">
			...
			<div className="monke-user-wrap">
				<div className="monke-user-thumb">
					<img src="/images/all-img/blog/user.png" alt="" />
				</div>
				<div className="monke-user-data">
					<ul>
					...
					<p>
						“Here, I'm rating the monke crypto app and the debit card. My experience is great! and as the app
						is very well designed. Crypto is a marketing is very good and I think it'll to win.”
					</p>
				</div>
				<div className="monke-social-icon3">
					<ul>
						<li>
							<Link href={"#"}>
								<svg
			...
			<div className="monke-blog-post-wrap">
				<Link href={"#"} legacyBehavior>
					<a className="monke-blog-post-column">
						<div className="monke-blog-post-arrow">
							<div className="monke-blog-post-arrow-icon">
								<img src="/images/svg/arrow-black-left.svg" alt="" />
							</div>
							<div className="monke-blog-post-arrow-data">
								<p>Previous post</p>
							</div>
						</div>
				...
				<Link href={"#"} legacyBehavior>
					<a className="monke-blog-post-column post-column-right">
						<div className="monke-blog-post-arrow">
							<div className="monke-blog-post-arrow-data">
								<p>Next post</p>
							</div>
