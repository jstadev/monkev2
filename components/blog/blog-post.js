		...
		<div className="col-xl-8 col-lg-7">
			<div className="row">
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay="0s">
				...
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay=".10s">
						<div className="monke-blog-thumb">
							<Link href={"/single-blog-light"}>
				...
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay=".20s">
						<div className="monke-blog-thumb">
							<Link href={"/single-blog-light"}>
				...
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay=".30s">
						<div className="monke-blog-thumb">
							<Link href={"/single-blog-light"}>
				...
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay=".40s">
						<div className="monke-blog-thumb">
							<Link href={"/single-blog-light"}>
				...
				<div className="col-xl-6 col-lg-12 col-md-6">
					<div className="monke-blog-card wow fadeInUpX" data-wow-delay=".50s">
						<div className="monke-blog-thumb">
							<Link href={"/single-blog-light"}>
