	...
	return (
		<footer className="monke--footer-section">
			<div className="container">
				...
				<div className="monke--footer-bottom">
					assets <p>&copy; Copyright 2023, All Rights Reserved by MonkeCrypto</p>
					<div className="monke--footer-menu">
						{/* <ul >
							<li >
								<Link href="#"><img src="/images/social2/twitter.svg" alt="" /> </Link>
							</li>
							<li>
								<Link href="#"> <img src="/images/social2/telegram.svg" alt="" /> </Link>
							</li>
						</ul> */}
					</div>
				</div>
