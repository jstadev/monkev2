...
export default function HeaderHomeTwo() {
	...
	return (
		<header
			className={`site-header monke--header-two monke-header-section ${scroll ? "sticky-menu" : ""}`}
			id="sticky-menu"
		>
			<div className="container-fluid">
				<nav className="navbar site-navbar">
					...
					<div className="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
						<a className="monke-btn monke-header-btn monke-header-btn2" href="contact.html">
							Get Started
						</a>
					</div>
