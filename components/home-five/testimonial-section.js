...
export default function TestimonialSection() {
	return (
		<div className="monke--testimonial-section monke--section-padding">
			<div className="container">
				<div className="monke--section-title">
					<div className="monke--default-content">
						<h2>Users around the world have a great experience with monke</h2>
						<p>
							monke is a place of trust for millions of people. Our customer reviews overall and is rated
				...
				<div className="row">
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay="0s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
							...
							<div className="monke--testimonial-data">
								<p>
									“I found monke very professional and trustworthy during my crypto trading duration of
									147 days. They are very honest and trusted.”
								</p>
							</div>
							<div className="monke--testimonial-author">
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay=".10s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
										<img src="/images/svg2/star.svg" alt="" />
							...
							<div className="monke--testimonial-data">
								<p>
									“100% Trusted. Very legit in crypto world. So far I'm satisfied with monke. I just
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
										<img src="/images/svg2/star.svg" alt="" />
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay=".30s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
										<img src="/images/svg2/star.svg" alt="" />
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay=".40s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
										<img src="/images/svg2/star.svg" alt="" />
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--testimonial-wrap wow fadeInUpX" data-wow-delay=".50s">
							<div className="monke--testimonial-rating">
								<ul>
									<li>
										<img src="/images/svg2/star.svg" alt="" />
				...
				<div className="monke--testimonial-button">
					<Link href={"#"} legacyBehavior>
						<a className="monke--btn bg-blue">View All Reviews</a>
					</Link>
				</div>
			</div>
		</div>
