...
export default function FeatureSection() {
	return (
		<div className="monke--feature-section monke--section-padding2">
			<div className="container">
				...
				<div className="row">
					<div className="col-xl-4 col-md-6">
						<div
							className="monke--iconbox-wrap monke--iconbox-wrap3 monke--iconbox-wrap4 wow fadeInUpX"
							data-wow-delay="0s"
						>
							<div className="monke--iconbox-thumb">
								<img src="/images/all-img/about2/feature1.png" alt="" />
							</div>
					...
					<div className="col-xl-4 col-md-6">
						...
						>
							<div className="monke--iconbox-thumb">
								<img src="/images/all-img/about2/feature2.png" alt="" />
							</div>
							<div className="monke--iconbox-data">
					...
					<div className="col-xl-4 col-md-6">
						...
						>
							<div className="monke--iconbox-thumb">
								<img src="/images/all-img/about2/feature3.png" alt="" />
							</div>
							<div className="monke--iconbox-data">
								<h4>Creative team</h4>
								<p>
