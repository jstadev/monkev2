...
export default function RelatedProjectSection() {
	return (
		<div className="monke-portfolio-ratated-project">
			...
			<div className="row">
				<div className="col-lg-4 col-md-6">
					<div className="monke-gallery-item wow fadeInUpX" data-wow-delay="0s">
				...
				<div className="col-lg-4 col-md-6">
					<div className="monke-gallery-item wow fadeInUpX" data-wow-delay=".10s">
				...
				<div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
					<div className="monke-gallery-item wow fadeInUpX" data-wow-delay=".20s">
