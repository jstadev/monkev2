...
export default function FeatureSectionTwo() {
	return (
		<div className="section bg-gray-800 monke-section-padding3">
			<div className="container">
				<div className="monke-section-title title-white">
					<h2>Everything you need for crypto trading is available</h2>
				</div>
				<div className="row">
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0s">
							<div className="monke-iconbox-icon3">
								<img src="/images/all-img/v2/icon4.png" alt="" />
							</div>
							<div className="monke-iconbox-data3">
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.10s">
							<div className="monke-iconbox-icon3">
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.20s">
							<div className="monke-iconbox-icon3">
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.30s">
							<div className="monke-iconbox-icon3">
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.40s">
							<div className="monke-iconbox-icon3">
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.50s">
							<div className="monke-iconbox-icon3">
