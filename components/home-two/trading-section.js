...
export default function TradingSection() {
	return (
		<div className="section bg-warning-100 monke-section-padding overflow-hidden">
			<div className="container">
				<div className="row">
					<div className="col-lg-6">
						<div className="monke-trading-card">
							<div className="monke-trading-card-thumb">
								<img
									...
									alt=""
								/>
								<div className="monke-trading-card-thumb2">
									<img
								...
								<div className="monke-shape6">
									<img src="/images/shape/shape5.png" alt="" />
								</div>
								<div className="monke-shape7">
					...
					<div className="col-lg-6 col-md-10 d-flex align-items-center">
						<div className="monke-default-content z-index">
							...
							<div className="monke-icon-list monke-icon-list3">
								<ul>
									<li>
