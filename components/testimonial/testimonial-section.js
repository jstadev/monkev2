			...
			<div className="container">
				...
				<div className="row">
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay="0s">
							<ul>
								<li>
							...
							<p>
								“I found monke very professional and trustworthy during my crypto trading duration of 147
							...
							<div className="monke-testimonial-author-wrap">
								...
								<div className="monke-testimonial-author-data3">
									<h5>- Karen Lynn</h5>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".10s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".20s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".30s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".40s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".50s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".60s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".70s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
					...
					<div className="col-xl-4 col-lg-6 col-md-6">
						<div className="monke-testimonial-card3 wow fadeInUpX" data-wow-delay=".80s">
							<ul>
								<li>
									<img src="/images/svg/star4.svg" alt="" />
								</li>
				...
				<div className="monke-testimonial-btn">
					<Link href={"#"} legacyBehavior>
						<a className="monke-btn small-btn">View More</a>
					</Link>
				</div>
			</div>
		</div>
