...
export default function ArtWorkSection() {
	return (
		<div className="monke--artwork-section">
			<div id="monke--counter2"></div>
			<div className="container">
				<div className="row">
					<div className="col-lg-6 order-lg-2">
						<div className="monke--artwork-right">
							<div className="monke--artwork-thumb" id="rotatetwo">
								<img
					...
					<div className="col-lg-5">
						<div className="monke--default-content content-black">
							...
							<div className="monke--counter-wrap monke--counter-wrap2">
								<div className="monke--counter-data">
									<h2>
										<span data-percentage="45" className="monke--counter"></span>
										<CountUp end={45} />
										<strong>K</strong>
									</h2>
								...
								<div className="monke--counter-data">
									<h2>
										<span data-percentage="86" className="monke--counter"></span>
										<CountUp end={86} />
										<strong>K</strong>
									</h2>
									<p>Global Creators</p>
