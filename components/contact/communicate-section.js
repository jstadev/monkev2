			...
			<div className="container">
				...
				<div className="row">
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap4 wow fadeInUpX" data-wow-delay="0s">
							<div className="monke-iconbox-icon4">
								<img src="/images/all-img/contact/icon1.png" alt="" />
							</div>
							<div className="monke-iconbox-data4">
								<h4>Careers</h4>
					...
					<div className="col-lg-4 col-md-6">
						<div className="monke-iconbox-wrap4 wow fadeInUpX" data-wow-delay=".10s">
							<div className="monke-iconbox-icon4">
					...
					<div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
						<div className="monke-iconbox-wrap4 wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke-iconbox-icon4">
