...
export default function FeatureSection() {
	return (
		<div className="monke--feature2-section monke--section-padding2">
			<div className="container">
				...
				<div className="row">
					<div className="col-xl-4 col-md-6">
						<div className="monke--feature-wrap wow fadeInUpX" data-wow-delay=".10s">
							<div className="monke--feature-data">
								<h2>01</h2>
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--feature-wrap wow fadeInUpX" data-wow-delay=".20s">
							<div className="monke--feature-data">
								<h2>02</h2>
					...
					<div className="col-xl-4 col-md-6">
						<div className="monke--feature-wrap wow fadeInUpX" data-wow-delay=".30s">
							<div className="monke--feature-data">
								<h2>03</h2>
