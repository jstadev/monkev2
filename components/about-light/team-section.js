...
export default function TeamSection() {
	return (
		<div className="monke--team-section monke--team-three monke--section-padding2">
			<div className="container">
				<div className="monke--section-title-wrap">
					...
					<div className="monke--section-button">
						<a className="monke--btn bg-orange" href="">
							View All Members
						</a>
					</div>
				</div>
						...
						<div key={uuidv4()} className="col-xl-3 col-md-6">
							<div className="monke--team-wrap wow fadeInUpX" data-wow-delay=".10s">
								...
								<div className="monke--team-data">
									<h4>{el.name}</h4>
									<p>{el.designation}</p>
									<div className="monke--social-icon monke--social-icon4">
										<ul>
											<li>
											...
											<li>
												<Link href={el.liUserName}>
													...
													>
														<path
															d="M20.1831 20.0002V12.6752C20.1831 9.0752 19.4081 6.3252 15.2081 6.3252C13.1831 6.3252 11.8331 7.4252 11.2831 8.4752H11.2331V6.6502H7.25806V20.0002H11.4081V13.3752C11.4081 11.6252 11.7331 9.9502 13.8831 9.9502C16.0081 9.9502 16.0331 11.9252 16.0331 13.4752V19.9752H20.1831V20.0002Z"
															fill="#13111A"
														/>
														<path
															d="M0.508301 6.65039H4.6583V20.0004H0.508301V6.65039Z"
															fill="#13111A"
														/>
														<path
															d="M2.58311 0C1.25811 0 0.183105 1.075 0.183105 2.4C0.183105 3.725 1.25811 4.825 2.58311 4.825C3.90811 4.825 4.98311 3.725 4.98311 2.4C4.98311 1.075 3.90811 0 2.58311 0Z"
															fill="#13111A"
														/>
													</svg>
												</Link>
